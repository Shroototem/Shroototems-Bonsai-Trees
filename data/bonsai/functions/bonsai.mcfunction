execute if block ^ ^1 ^-1 minecraft:potted_oak_sapling run loot spawn ^ ^1 ^-1 loot bonsai:oak
execute if block ^ ^1 ^-1 minecraft:potted_birch_sapling run loot spawn ^ ^1 ^-1 loot bonsai:birch
execute if block ^ ^1 ^-1 minecraft:potted_spruce_sapling run loot spawn ^ ^1 ^-1 loot bonsai:spruce
execute if block ^ ^1 ^-1 minecraft:potted_jungle_sapling run loot spawn ^ ^1 ^-1 loot bonsai:jungle
execute if block ^ ^1 ^-1 minecraft:potted_acacia_sapling run loot spawn ^ ^1 ^-1 loot bonsai:acacia
execute if block ^ ^1 ^-1 minecraft:potted_dark_oak_sapling run loot spawn ^ ^1 ^-1 loot bonsai:darkoak
